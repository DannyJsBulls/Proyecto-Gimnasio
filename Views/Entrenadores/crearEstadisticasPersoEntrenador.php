                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Registrar Estadisticas Actividades Personalizadas </h1>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
                        ...
                        <div class="col-lg-12">
                            <div class=card>
                                <div class="card-title">
                                    ...
                                    <h4>Por favor complete los campos para registrar una Estadistica de Actividad Personalizada</h4>
                                </div>
                            
                                <div class="card-body">
                                    <!-- Parara qye un formulario pueda capturar archivos debe tener un atributo mas en la la eiqueta form que es ectyoe -->
                                    <form action="../../Controller/registrarEntrenador/registrarEstadisticasPersoEntrenador.php" method="POST">
                                        <div class="row">
                                            <div class="form-group col-lg-4 col-md-6">
                                                <label>IDENTIFICACION CLIENTE</label>
                                                <input type="number" class="form-control" placeholder="Ingrese un numero de id" name="id_cliente">
                                            </div>
                                            <div class="form-group col-lg-4 col-md-6">
                                                <label>IDENTIFICACION ENTRENADOR</label>
                                                <input type="number" class="form-control" placeholder="Ingrese un numero de id" name="id_entrenador">
                                            </div>
                                            <div class="form-group col-lg-4 col-md-6">
                                                <label>NUM.REFERENCIA ACTIVIDAD</label>
                                                <select class="form-control" name="nombre_actividad">
                                                    <option>Seleccione una Actividad</option>
                                                    <!-- Aquí debes llenar las opciones del select con los valores de la clave primaria de actividades -->
                                                    <?php
                                                        // Suponiendo que tienes acceso a la base de datos, puedes obtener las claves primarias de actividades
                                                        // y mostrarlas como opciones en el select
                                                        // Esto es solo un ejemplo, asegúrate de ajustarlo a tu entorno y tecnología
                                                        $conexion = new mysqli("localhost", "root", "", "gimnasio_bd");
                                                        $query = "SELECT nombre_actividad, codigo_actividad FROM actividades";
                                                        $result = $conexion->query($query);
                                                        while ($row = $result->fetch_assoc()) {
                                                            echo "<option value='" . $row['nombre_actividad'] . "'>" . $row['nombre_actividad'] . "</option>";
                                                        }
                                                        $conexion->close();
                                                    ?>
                                                </select>
                                            ...
                                            <div class="form-group col-lg-4 col-md-6">
                                                ...
                                                <input type="date" class="form-control" placeholder="Ingrese la fecha de la actividad" name="fecha_actividad_estadistica_personalizada">
                                            </div>
                                            <div class="form-group col-lg-4 col-md-6">
                                                <label>DURACION ACTIVIDAD</label>
                                                <input type="text" class="form-control" placeholder="Ingrese la duracion de la actividad" name="duracion_actividad_estadistica_personalizada">
                                            </div>
                                            <div class="form-group col-lg-4 col-md-6">
                                                <label>REPETICIONES ACTIVIDAD</label>
                                                <input type="number" class="form-control" placeholder="Ingrese cuantas repeticiones se establecieron" name="repeticiones_actividad_estadistica_personalizada">
                                            </div>
                                            <div class="form-group col-lg-4 col-md-6">
                                                <label>PESO LEVANTADO</label>
                                                <input type="number" class="form-control" placeholder="Ingrese el peso levantado" name="peso_levantado_estadistica_personalizada" step="0.1">
                                            </div>
                                            <div class="form-group  col-lg-4 col-md-6">
                                                <label>DISTANCIA RECORRIDA</label>
                                                <input type="number" class="form-control" placeholder="Ingrese la distancia recorrida" name="distancia_recorrida_estadistica_personalizada" step="0.1">
                                            </div>
                                            <div class="form-group  col-lg-4 col-md-6">
                                                <label>VELOCIDAD PROMEDIO</label>
                                                <input type="number" class="form-control" placeholder="Ingrese la velocidad promedio" name="velocidad_promedio_estadistica_personalizada" step="0.1">
                                            </div>
                                            <div class="form-group col-lg-4 col-md-6">
                                                <label>CALORIAS QUEMADAS</label>
                                                <input type="number" class="form-control" placeholder="Ingrese las calorias quemadas" name="calorias_quemadas_estadistica_personalizada">
                                            </div>
                                            <div class="form-group col-lg-4 col-md-6">
                                                <label>NIVEL ESFUERZO</label>
                                                <input type="number" class="form-control" placeholder="Ingrese el nivel de esfuerzo" name="nivel_esfuerzo_estadistica_personalizada">
                                            </div>
                                            <div class="form-group col-lg-4 col-md-6">
                                                <label>TIPO DE EJERCICIO</label>
                                                <input type="text" class="form-control" placeholder="Ingrese el tipo de jercicio" name="tipo_ejercicio_estadistica_personalizada">
                                            </div>
                                            <div class="form-group col-lg-4 col-md-6">
                                                <label>ZONA FRECUENCIA CARDIACA</label>
                                                <input type="text" class="form-control" placeholder="Ingrese la zona de la frecuencia cardiaca" name="zona_frecuencia_cardiaca_estadistica_perso">
                                            </div>
                                            <div class="form-group col-lg-4 col-md-6">
                                            ...
                                            <div class="form-group col-lg-4 col-md-6">
                                                ...
                                                <input type="number" class="form-control" placeholder="Ingrese la dificultad de la actividad" name="dificultad_actividad_estadistica_personalizada">
                                            </div>
                                            <div class="form-group col-lg-4 col-md-6">
                                                <label>DESCANSO ENTRE SERIES</label>
                                                <input type="text" class="form-control" placeholder="Ingrese el descanso entre series" name="descanso_entre_series_estadistica_perso">
                                            </div>
                                            <button type="submit" class="btn btn-primary">Registrar Estadistica</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
