<?php
    ...
    require_once("../../Controller/mostrarEntrenador/mostrarComprasEntrenadores.php");
                            ...
                            <div class="card-entrenador">
                                <div class="card-title">
                                    <div class="d-flex flex-column flex-lg-row justify-between align-items-lg-center">
                                        <div class="col-lg-6">
                                            <h1 class="titulo-perfil factura">Comprobante de Pago Productos</h1>
                                ...
                                <div class="card-body">
                                    <?php
                                        cargarComprasEntrenadores($id_usuario);
                                    ?>
                                </div>
                            </div>
                        </div>
