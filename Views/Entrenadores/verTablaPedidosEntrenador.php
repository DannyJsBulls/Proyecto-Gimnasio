<?php
    ...
    require_once("../../Controller/mostrarEntrenador/mostrarInfoPedidosEntrenadores.php");
                        ...
                        <div class="col-lg-12">
                            <div class=card>
                                <div class="card-title">
                                    <h1>Tabla Informacion Pedidos de Productos</h1>
                                    ...
                                    <div class="table-responsive">
                                        <table id="bootstrap-data-table-export" class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <?php
                                                    if(isset($id_usuario)){
                                                        mostrarInfoPedidosEntrenador($id_usuario);
                                                    }
                                                ?>
                                            </tbody>
                                        </table>
