<?php
    ...
    require_once("../../Controller/mostrarEntrenador/mostrarInscripcionesPersoEntrenador.php");
                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Inscripciones Personalizadas de Actividades Asignadas</h1>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
                        ...
                        <div class="col-lg-12">
                            <div class=card>
                                <div class="card-title">
                                    <h1>Tabla Informacion Inscripciones Asignadas</h1>
                                    ...
                                    <div class="table-responsive">
                                        <table id="bootstrap-data-table-export" class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <?php
                                                    if(isset($id_usuario)){
                                                        mostrarInscripcionesPersoEntrenador($id_usuario);
                                                    }
                                                ?>
                                            </tbody>
                                        </table>
