<?php
    ...
    require_once("../../Controller/mostrarEntrenador/mostrarProductosEntrenador.php");
                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Productos de Gimnasio Para Ti </h1>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
                        ...
                        <div class="col-lg-12">
                            <div class="card-extend">
                                <div class="card-title">
                                    <h1 class="titulo-perfil">Informacion De Producto</h1>
                                    <p class="parrafo-perfil">Por Favor seleccione la accion que desea realizar</p>
                                </div>
                                <div class="card-body">
                                    <?php
                                        cargarProductosEntrenador();
                                    ?>
                                </div>
                            </div>
                        </div>
