<?php
    ...
    require_once("../../Controller/mostrarEntrenador/mostrarPedidosEntrenadores.php");
                        ...
                        <div class="col-lg-12">
                            <div class="card-entrenador">
                                <div class="card-title">
                                    <div>
                                        <h1 class="titulo-perfil">Detalle Pedido</h1>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <?php
                                        cargarPedidosProductosEntrenadores();
                                    ?>
                                    <div class="card-title">
                                        <div>
                                            <h1 class="titulo-perfil pedidos">Producto(s)</h1>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <?php
                                            cargarPedidosProductosEntre();
                                        ?>
                                    </div>
                                </div>
                            </div>
