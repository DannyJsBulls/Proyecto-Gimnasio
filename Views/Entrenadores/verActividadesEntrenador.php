<?php
    ...
    require_once("../../Controller/mostrarEntrenador/mostrarActividadesEntrenador.php");
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-title">
                                    <h1 class="titulo-perfil">ACTIVIDADES REALIZADAS EN EL GIMNASIO</h1>
                                    <p class="parrafo-perfil">Por Favor seleccione la accion que desea realizar</p>
                                </div>
                                <div class="row actividades"> 
                                    <?php
                                        mostrarActividadesEntrenador($id_usuario);
                                    ?>
                                </div>
                            </div>
                        </div>
