<?php
    ...
    require_once("../../Controller/mostrarAdmin/mostrarPagosEntrenadoresAdmin.php");
                            ...
                            <div class="card-entrenador">
                                <div class="card-title">
                                    <div class="d-flex flex-column flex-lg-row justify-between align-items-lg-center">
                                        <div class="col-lg-6">
                                            <h1 class="titulo-perfil factura">Comprobante de Pago Entrenadores</h1>
                                        ...
                                        <!-- <div class="col-lg-6 d-flex justify-content-lg-end domwload">
                                            <button class="btn btn-primary w-50 align-self-end">Descargar Recibo <i class="icofont-download"></i></button>
                                        </div> -->
                                    </div>
                                    <div class="card-body">
                                        <?php
                                            cargarPagosEntrenadoresAdmin();
                                        ?>
                                    </div>
                                </div>
                            </div>
