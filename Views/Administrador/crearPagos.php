                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Registrar Ventas de Planes </h1>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="../../Controller/registrarAdmin/registrarPagosPlanesAdmin.php" method="POST">
                                        <div class="row">
                                            ...
                                            <button type="submit" class="btn btn-primary">Vender Plan</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
