<?php
    ...
    require_once("../../Controller/mostrarAdmin/mostrarActividadesAdmin.php");
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-title">
                                    <h1>Tabla Informacion Actividades</h1>
                                        ...
                                        <table id="bootstrap-data-table-export" class="table table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>REQUISITOS ACTIVIDAD</th>
                                                    <th>ESTADO ACTIVIDAD</th>
                                                    <th>OBJETIVOS ACTIVIDAD</th>
