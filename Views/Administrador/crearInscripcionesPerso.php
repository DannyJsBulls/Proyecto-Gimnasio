                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Inscribir Actividades Personalizadas</h1>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
                        ...
                        <div class="col-lg-12">
                            <div class=card>
                                <div class="card-title">
                                    ...
                                    <h4>Por favor complete los campos para inscribirse en una actividad</h4>
                                </div>
                                <div class="card-body">
                                    <!-- Parara qye un formulario pueda capturar archivos debe tener un atributo mas en la la eiqueta form que es ectyoe -->
                                    <form action="../../Controller/registrarAdmin/registrarInscripcionesPersoAdmin.php" method="POST">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-lg-4 col-md-6">
                                                <label>ELIGE EL PLAN ADQUIRIDO</label>
                                            ...
                                            <div class="form-group col-lg-4 col-md-6">
                                                ...
                                                <input type="date" class="form-control" name="fecha_inscripcion_personalizada">
                                            </div>
                                            <div class="form-group col-lg-4 col-md-6">
                                                <label>FECHA PROGRAMADA PARA LA ACTIVIDAD</label>
                                                <input type="date" class="form-control" name="fecha_inicio_actividad">
                                            </div>
                                            <div class="form-group  col-lg-4 col-md-6">
                                                <label>HORA PROGRAMA PARA LA ACTIVIDAD</label>
                                                <input type="time" class="form-control" name="hora_inicio_actividad">
                                            </div>
                                            <div class="form-group col-lg-4 col-md-6">
                                            ...
                                            <div class="form-group col-lg-4 col-md-6">
                                                ...
                                                <input type="textarea" class="form-control" placeholder="Ingrese una comentario" name="comentarios_inscripcion_personalizada">
                                            </div>
                                            <button type="submit" class="btn btn-primary">Inscribir Actividades</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
