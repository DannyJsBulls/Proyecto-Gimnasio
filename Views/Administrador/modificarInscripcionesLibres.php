                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Modificar Inscripciones Libres</h1>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
                        ...
                        <div class="col-lg-12">
                            <div class=card>
                                <div class="card-title">
                                    ...
                                    <h4>Por favor modifique los campos para actualizar la informacion de la inscripcion libre</h4>
                                </div>

                                <div class="card-body">
                                    <?php
                                        cargarInscripcionesLibres();
                                    ?>
                                </div>
                            </div>
                        </div>
