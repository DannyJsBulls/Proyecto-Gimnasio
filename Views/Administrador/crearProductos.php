                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Registrar Productos de Gimnasio</h1>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
                        ...
                        <div class="col-lg-12">
                            <div class=card>
                                <div class="card-title">
                                    ...
                                    <h4>Por favor complete los campos para registrar un nuevo producto de gimnasio</h4>
                                </div>
                                <div class="card-body">
                                    <!-- Parara qye un formulario pueda capturar archivos debe tener un atributo mas en la la eiqueta form que es ectyoe -->
                                    <form action="../../Controller/registrarAdmin/registrarProductosAdmin.php" method="POST" enctype="multipart/form-data">
                                        <div class="row">
                                            ...
                                            <!-- <div class="form-group col-lg-4 col-md-6">
                                                ...
                                                <input type="number" class="form-control" placeholder="Ingrese un porcentaje" name="porcentaje_ganancia_producto">
                                            </div>
                                            <div class="form-group col-lg-4 col-md-6">
