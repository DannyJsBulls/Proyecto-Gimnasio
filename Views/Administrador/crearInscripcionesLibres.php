                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Inscribir Actividades Libres</h1>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
                        ...
                        <div class="col-lg-12">
                            <div class=card>
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="../../Controller/registrarAdmin/registrarInscripcionesLibresAdmin.php" method="POST">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-lg-4 col-md-6">
                                                <label>FECHA DE LA INSCRIPCION</label>
                                                <input type="date" class="form-control" name="fecha_inscripcion_libre">
                                            </div>
                                            <div class="form-group col-lg-4 col-md-6">
                                            ...
                                            <div class="form-group col-lg-4 col-md-6">
                                                ...
                                                <input type="textarea" class="form-control" placeholder="Ingrese una comentario" name="comentarios_inscripcion_libre">
                                            </div>
