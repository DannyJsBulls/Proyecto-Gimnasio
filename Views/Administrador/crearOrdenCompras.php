                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Registrar Ordenes de Pagos con Proveedores </h1>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
                        ...
                        <div class="col-lg-12">
                            <div class=card>
                                <div class="card-title">
                                    ...
                                    <h4>Por favor complete los campos para registrar un nuevo pago</h4>
                                </div>
                                <div class="card-body">
                                    <!-- Parara qye un formulario pueda capturar archivos debe tener un atributo mas en la la eiqueta form que es ectyoe -->
                                    <form action="../../Controller/registrarAdmin/registrarComprasAdmin.php" method="POST">
                                        <div class="row">
                                            <div class="form-group col-lg-4 col-md-6">
                                                ...
                                                <select class="form-control" name="nombre_producto">
                                                    ...
                                                    <?php
                                                        ...
                                                        $query = "SELECT nombre_producto, codigo_producto FROM productos";
                                            ...
                                            <div class="form-group col-lg-4 col-md-6">
                                                ...
                                                <input type="number" class="form-control" placeholder="Ingrese un id de proveedor" name="id_proveedor">
                                            </div>
                                            <div class="form-group col-lg-4 col-md-6">
                                                <label>DIRECCION GIMNASIO</label>
                                                <input type="text" class="form-control" placeholder="Ingrese una direccion" name="direccion_gimnasio">
                                            </div>
                                            <div class="form-group col-lg-4 col-md-6">
                                                <label>ELIGE LA FORMA DE ENTREGA</label>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="forma_entrega_pedido_proveedor" value="Enviar direccion gimnasio" id="flexRadioDefault2" checked>
                                                    <label class="form-check-label" for="flexRadioDefault2">
                                                        Enviar direccion Gimnasio
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="forma_entrega_pedido_proveedor" value="Retirar en punto de entrega" id="flexRadioDefault1">
                                            ...
                                            <div class="form-group col-lg-4 col-md-6">
                                                ...
                                                <input type="date" class="form-control" name="fecha_entrega_pedido_proveedor">
                                            </div>
                                            <div class="form-group col-lg-4 col-md-6">
                                                <label>HORA ENTREGA PEDIDO</label>
                                                <input type="time" class="form-control" name="hora_entrega_pedido_proveedor">
                                            </div>
                                            <div class="form-group col-lg-4 col-md-6">
                                                <label>¿Como Quires Pagar?</label>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="metodo_pago_pedido_proveedor" id="flexRadioDefault2" checked>
                                                    <label class="form-check-label" for="flexRadioDefault2">
                                                        <i class="icofont-visa-electron"></i>  Visa Debito **** 1784
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="metodo_pago_pedido_proveedor" value="Tarjeta de Crédito" id="flexRadioDefault1">
                                                    <label class="form-check-label" for="flexRadioDefault1">
                                                        <i class="icofont-credit-card"></i> Tarjeta de Credito
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="metodo_pago_pedido_proveedor" value="Tarjeta de Débito" id="flexRadioDefault1">
                                                    <label class="form-check-label" for="flexRadioDefault1">
                                                        <i class="icofont-credit-card"></i> Tarjeta de Debito
                                                    </label>
                                                </div>
                                                <label>Con Otra Forma de Pago</label>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="metodo_pago_pedido_proveedor" value="Transferencia desde un banco con PSE" id="flexRadioDefault1">
                                                    <label class="form-check-label" for="flexRadioDefault1">
                                                        <i class="icofont-bank-alt"></i> Transferencia desde tu banco con PSE
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="metodo_pago_pedido_proveedor" value="Pago en efectivo con Efecty" id="flexRadioDefault1">
                                                    <label class="form-check-label" for="flexRadioDefault1">
                                                        <i class="icofont-bill-alt"></i> Pagos en efectivo con Efecty
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="form-group col-lg-4 col-md-6">
                                                <label>CANTIDAD PRODUCTOS</label>
                                                <input type="number" class="form-control" placeholder="Ingrese una cantidad" name="cantidad_productos_compra">
                                            </div>
                                            <div class="form-group col-lg-4 col-md-6">
                                                <label>PRECIO COMPRA</label>
                                                <input type="number" class="form-control" placeholder="Ingrese un precio" name="precio_final_compra_producto">
                                            </div>
                                            <div class="form-group col-lg-4 col-md-6">
