                    ...
                    <div class="col-lg-12">
                        <div class=card>
                            <div class="card-title">
                                ...
                                <h4>Por favor complete los campos para registrar un nuevo usuario</h4>
                            </div>
                        
                            <div class="card-body">
                                <!-- Parara qye un formulario pueda capturar archivos debe tener un atributo mas en la la eiqueta form que es ectyoe -->
                                <form action="../../Controller/registrarAdmin/registrarUserAdmin.php" method="POST" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="form-group col-lg-4 col-md-6">
                                            <label>NUMERO IDENTIFICACION</label>
                                            <input type="number" class="form-control" placeholder="Ingrese el numero" name="id_usuario">
                                        </div>
                                        <div class="form-group col-lg-4 col-md-6">
                                        ...
                                        <div class="form-group col-lg-4 col-md-6">
                                            <label>NOMBRES</label>
                                            <input type="text" class="form-control" placeholder="Ingrese los nombres" name="nombres_usuario">
                                        </div>
                                        <div class="form-group col-lg-4 col-md-6">
                                            <label>APELLIDOS</label>
                                            <input type="text" class="form-control" placeholder="Ingrese los apellidos" name="apellidos_usuario">
                                        </div>
                                        <div class="form-group col-lg-4 col-md-6">
                                            <label>FECHA DE NACIMIENTO</label>
                                            <input type="date" class="form-control" name="fecha_nacimiento_usuario">
                                        </div>
                                        <div class="form-group col-lg-4 col-md-6">
                                            <label>EMAIL</label>
                                            <input type="email" class="form-control" placeholder="Ingrese un email" name="email_usuario">
                                        </div>
                                        <div class="form-group col-lg-4 col-md-6">
                                            <label>TELEFONO</label>
                                            <input type="number" class="form-control" placeholder="Ingrese un numero de telefono" name="telefono_usuario">
                                        </div>
                                        <div class="form-group col-lg-4 col-md-6">
                                            <label>ESTADO</label>
                                        ...
                                        <div class="form-group col-lg-4 col-md-6">
                                            ...
                                            <input type="password" class="form-control" placeholder="Ingrese una Contraseña" name="clavemd">
                                        </div>
                                        <div class="form-group col-lg-4 col-md-6">
                                            <label>FOTO</label>
