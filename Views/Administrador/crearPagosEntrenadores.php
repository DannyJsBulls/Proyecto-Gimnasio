                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Registrar Pagos a Entrenadores </h1>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
                        ...
                        <div class="col-lg-12">
                            <div class=card>
                                <div class="card-title">
                                    ...
                                    <h4>Por favor complete los campos para registrar un nuevo pago de entrenador</h4>
                                </div>
                                <div class="card-body">
                                    <!-- Parara qye un formulario pueda capturar archivos debe tener un atributo mas en la la eiqueta form que es ectyoe -->
                                    <form action="../../Controller/registrarAdmin/registrarPagosEntrenadoresAdmin.php" method="POST">
                                        <div class="row">
                                            <div class="form-group col-lg-4 col-md-6">
                                                <label>IDENTIFICACION ENTRENADOR</label>
                                                <input type="number" class="form-control" placeholder="Ingrese un id de entrenador" name="id_entrenador">
                                            </div>
                                            <div class="form-group col-lg-4 col-md-6">
                                                <label>FECHA PAGO</label>
                                                <input type="date" class="form-control" name="fecha_pago_entrenador">
                                            </div>
                                            <div class="form-group col-lg-4 col-md-6">
                                                <label>HORA PAGO</label>
                                                <input type="time" class="form-control" name="hora_pago_entrenador">
                                            </div>
                                            <div class="form-group col-lg-4 col-md-6">
                                                <label>¿Como Quires Pagar?</label>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="metodo_pago_entrenador" id="flexRadioDefault2" checked>
                                                    <label class="form-check-label" for="flexRadioDefault2">
                                                        <i class="icofont-visa-electron"></i>  Visa Debito **** 1784
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="metodo_pago_entrenador" value="Tarjeta de Crédito" id="flexRadioDefault1">
                                                    <label class="form-check-label" for="flexRadioDefault1">
                                                        <i class="icofont-credit-card"></i> Tarjeta de Credito
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="metodo_pago_entrenador" value="Tarjeta de Débito" id="flexRadioDefault1">
                                                    <label class="form-check-label" for="flexRadioDefault1">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="metodo_pago_entrenador" value="Transferencia desde un banco con PSE" id="flexRadioDefault1">
                                                    <label class="form-check-label" for="flexRadioDefault1">
                                                        <i class="icofont-bank-alt"></i> Transferencia desde tu banco con PSE
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="metodo_pago_entrenador" value="Pago  en efectivo con Efecty" id="flexRadioDefault1">
                                                    <label class="form-check-label" for="flexRadioDefault1">
                                            ...
                                            <div class="form-group col-lg-4 col-md-6">
                                                ...
                                                <input type="number" class="form-control" placeholder="Ingrese un precio" name="precio_final_pago_entrenador">
                                            </div>
                                            <div class="form-group col-lg-4 col-md-6">
