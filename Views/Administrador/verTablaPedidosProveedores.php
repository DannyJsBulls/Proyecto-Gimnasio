<?php
    ...
    require_once("../../Controller/mostrarAdmin/mostrarInfoPedidosProveedoresAdmin.php");
                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Pedidos de Proveedores Registrados En El Sistema </h1>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
                        ...
                        <div class="col-lg-12">
                            <div class=card>
                                <div class="card-title">
                                    <h1>Tabla Informacion Pedidos de Proveedores</h1>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table id="bootstrap-data-table-export" class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <?php
                                                    mostrarInfoPedidosProveedorAdmin();
                                                ?>
                                            </tbody>
                                        </table>
                                    </div>
