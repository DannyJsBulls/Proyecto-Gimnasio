                        ...
                        <div class="col-lg-12">
                            <div class=card>
                                <div class="card-title">
                                    ...
                                    <h4>Por favor complete los campos para registrar una nueva actividad</h4>
                                </div>
                            
                                <div class="card-body">
                                    <!-- Parara qye un formulario pueda capturar archivos debe tener un atributo mas en la la eiqueta form que es ectyoe -->
                                    <form action="../../Controller/registrarAdmin/registrarActividadesAdmin.php" method="POST" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="form-group col-lg-4 col-md-6">
                                                <label>NUM.REFERENCIA ACTIVIDAD</label>
                                                <input type="number" class="form-control" placeholder="Ingrese un numero" name="codigo_actividad">
                                            </div>
                                            <div class="form-group col-lg-4 col-md-6">
                                                <label>NOMBRE ACTIVIDAD</label>
                                                <input type="text" class="form-control" placeholder="Ingrese el nombre" name="nombre_actividad">
                                            </div>
                                            <div class="form-group col-lg-4 col-md-6">
                                                <label>DESCRIPCION</label>
                                                <input type="text" class="form-control" placeholder="Ingrese la descripcion de la actividad" name="descripcion_actividad">
                                            </div>
                                            <div class="form-group col-lg-4 col-md-6">
                                            ...
                                            <div class="form-group col-lg-4 col-md-6">
                                                ...
                                                <input type="text" class="form-control" placeholder="Ingrese los requisitos de la actividad" name="requisitos_actividad">
                                            </div>
                                            <div class="form-group col-lg-4 col-md-6">
                                            ...
                                            <div class="form-group col-lg-4 col-md-6">
                                                <label>OBEJTIVOS ACTIVIDAD</label>
                                                <input type="textarea" class="form-control" placeholder="Ingrese el objetivo de la actividad" name="objetivos_actividad">
                                            </div>
                                            <div class="form-group col-lg-4 col-md-6">
                                                <label>AREA ACTIVIDAD</label>
                                                <input type="text" class="form-control" placeholder="Ingrese el area de la actividad" name="area_actividad">
                                            </div>
                                            <div class="form-group col-lg-4 col-md-6">
                                                <label>FOTO</label>
