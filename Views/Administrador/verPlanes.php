<?php
    ...
    require_once("../../Controller/mostrarAdmin/mostrarPlanesAdmin.php");
                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Planes Registrados En El Sistema </h1>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
                        ...
                        <div class="col-lg-12">
                            <div class=card>
                                <div class="card-title">
                                    <h1>Tabla Informacion de Planes</h1>
                                        ...
                                        <table id="bootstrap-data-table-export" class="table table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>PRECIO FINAL</th>
                                                    <th>DURACION PLAN</th>
                                                    <th>ACCESO SERVICIOS PLAN</th>
                                                    <th>RESTRICCIONES PLAN</th>
                                                    <th>ESTADO PLAN</th>
                                                    <th>DESCUENTOS PLAN</th>
