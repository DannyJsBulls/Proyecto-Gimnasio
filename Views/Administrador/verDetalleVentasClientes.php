<?php
    ...
    require_once("../../Controller/mostrarAdmin/mostrarVentasClientesAdmin.php");
    ...
    if (isset($_SESSION['id_usuario'])) {
        ...
        echo '<h2>No se pudo obtener el ID del usuario en sesión.</h2>';
    }
                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Comprobante de pago Venta Productos</h1>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
                ...
                <section id="main-content">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card-entrenador">
                                <div class="card-title">
                                    <div class="d-flex flex-column flex-lg-row justify-between align-items-lg-center">
                                        <div class="col-lg-6">
                                            <h1 class="titulo-perfil factura">Comprobante de Pago Venta de Productos</h1>
                                            <p class="parrafo-perfil factura">Por favor seleccione la acción que desea realizar</p>
                                        </div>
                                        <!-- <div class="col-lg-6 d-flex justify-content-lg-end domwload">
                                            <button class="btn btn-primary w-50 align-self-end">Descargar Factura <i class="icofont-download"></i></button>
                                        </div> -->
                                    </div>
                                    <div class="card-body">
                                        <?php
                                            cargarVentasProductosAdmin();
                                        ?>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="footer">
                                    <p>2023 © Clientes Board. - <a href="#">DDMAA</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
