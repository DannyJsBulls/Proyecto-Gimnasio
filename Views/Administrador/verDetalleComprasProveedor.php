                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Comprobante de Pago Productos Proveedores</h1>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
                            ...
                            <div class="card-entrenador">
                                <div class="card-title">
                                    <div class="d-flex flex-column flex-lg-row justify-between align-items-lg-center">
                                        <div class="col-lg-6">
                                            <h1 class="titulo-perfil factura">Comprobante de Pago Productos Proveedores</h1>
                                    ...
                                    <div class="card-body">
                                        <?php
                                            cargarPagosProductosProveedores();
                                        ?>
                                    </div>
                                </div>
                            </div>
