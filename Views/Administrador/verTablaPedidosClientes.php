<?php
    ...
    require_once("../../Controller/mostrarAdmin/mostrarInfoPedidosClientesAdmin.php");
                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Pedidos de Clientes Registrados En El Sistema </h1>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
                        ...
                        <div class="col-lg-12">
                            <div class=card>
                                <div class="card-title">
                                    <h1>Tabla Informacion Pedidos de Clientes</h1>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table id="bootstrap-data-table-export" class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <?php
                                                    mostrarInfoPedidosClienteAdmin();
                                                ?>
                                            </tbody>
                                        </table>
                                    </div>
