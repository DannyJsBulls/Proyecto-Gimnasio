                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Modificar Pagos y Compras de Clientes</h1>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
                        ...
                        <div class="col-lg-12">
                            <div class=card>
                                <div class="card-title">
                                    ...
                                    <h4>Por favor modifique los campos para actualizar la informacion del pago y compra a proveedores</h4>
                                </div>

                                <div class="card-body">
                                    <?php
                                        cargarVentasClientes();
                                    ?>
                                </div>
                            </div>
                        </div>
