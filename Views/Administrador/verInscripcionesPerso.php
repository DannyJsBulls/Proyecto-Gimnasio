<?php
    ...
    require_once("../../Controller/mostrarAdmin/mostrarInscripcionesPersoAdmin.php");
                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Inscripcione Personalizadas de Actividades Registradas En El Sistema </h1>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
                        ...
                        <div class="col-lg-12">
                            <div class=card>
                                <div class="card-title">
                                    <h1>Tabla Informacion Inscripciones Personalizadas</h1>
