<?php
    ...
    require_once("../../Controller/mostrarAdmin/mostrarEstadisticasPersonalizadasAdmin.php");
                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Estadisticas De Actividades Personalizadas Registradas En El Sistema </h1>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
