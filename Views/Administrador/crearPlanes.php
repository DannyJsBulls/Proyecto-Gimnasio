                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Registrar Planes de Clientes </h1>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
                    ...
                    <div class="col-lg-12">
                        <div class=card>
                            <div class="card-title">
                                ...
                                <h4>Por favor complete los campos para registrar un nuevo Plan</h4>
                            </div>
                            <div class="card-body">
                                <!-- Parara qye un formulario pueda capturar archivos debe tener un atributo mas en la la eiqueta form que es ectyoe -->
                                <form action="../../Controller/registrarAdmin/registrarPlanesAdmin.php" method="POST">
                                    <div class="row">
                                        <div class="form-group col-lg-4 col-md-6">
                                            <label>NUM.REFERENCIA PLAN</label>
                                            <input type="number" class="form-control" placeholder="Ingrese un numero de un plan" name="codigo_plan">
                                        </div>
                                        <div class="form-group col-lg-4 col-md-6">
                                            <label>NOMBRE DEL PLAN</label>
                                            <input type="text" class="form-control" placeholder="Ingrese un nombre de un plan" name="nombre_plan">
                                        </div>
                                        <div class="form-group col-lg-4 col-md-6">
                                            <label>DESCRIPCION DEL PLAN</label>
                                            <input type="text" class="form-control" placeholder="Ingrese una descripcion del plan" name="descripcion_plan">
                                        </div>
                                        <div class="form-group col-lg-4 col-md-6">
                                            <label>PRECIO PLAN</label>
                                            <input type="number" class="form-control" placeholder="Ingrese un precio" name="precio_plan">
                                        </div>
                                        <!-- <div class="form-group col-lg-4 col-md-6">
                                            <label>PORCENTAJE DE GANANCIA</label>
                                            <input type="number" class="form-control" placeholder="Ingrese un precio" name="porcentaje_ganancia_plan" step = "0.1">
                                        </div>
                                        <div class="form-group col-lg-4 col-md-6">
                                            <label>PRECIO FINAL</label>
                                            <input type="number" class="form-control" placeholder="Ingrese un precio" name="precio_final_plan">
                                        </div> -->
                                        <div class="form-group col-lg-4 col-md-6">
                                            <label>DURACION PLAN</label>
                                            <input type="text" class="form-control" placeholder="Cuanto dura el plan" name="duracion_plan">
                                        </div>
                                        <div class="form-group col-lg-4 col-md-6">
                                            <label>ACCESO A SERVICIOS DEL PLAN</label>
                                            <input type="text" class="form-control" placeholder="Ingrese que servicios ofrece el plan" name="acceso_servicios_plan">
                                        </div>
                                        <div class="form-group col-lg-4 col-md-6">
                                            <label>RESTRICCIONES DEL PLAN</label>
                                            <input type="text" class="form-control" placeholder="Ingrese las restricciones que tiene el plan" name="restricciones_plan">
                                        </div>
                                        <div class="form-group col-lg-4 col-md-6">
                                            <label>ESTADO</label>
                                        ...
                                        <div class="form-group col-lg-4 col-md-6">
                                            ...
                                            <input type="text" class="form-control" placeholder="Ingrese el descuento que ofrece el plan" name="descuentos_plan">
                                        </div>
                                        <div class="form-group col-lg-4 col-md-6">
                                            <label>CATEGORIA DEL PLAN</label>
                                            <input type="text" class="form-control" placeholder="Ingrese una categora de actividades" name="categoria_plan">
                                        </div>
