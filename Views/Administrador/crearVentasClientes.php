                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Registrar Ventas De Productos</h1>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
                        ...
                        <div class="col-lg-12">
                            <div class=card>
                                <div class="card-title">
                                    ...
                                    <h4>Por favor complete los campos para registrar una nueva venta de productos</h4>
                                </div>
                                <div class="card-body">
                                    <!-- Parara qye un formulario pueda capturar archivos debe tener un atributo mas en la la eiqueta form que es ectyoe -->
                                    <form action="../../Controller/registrarAdmin/registrarVentasClientesAdmin.php" method="POST">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-lg-4 col-md-6">
                                                ...
                                                <input type="number" class="form-control" placeholder="Ingrese un id de usuario" name="id_usuario">
                                            </div>
                                            <div class="form-group col-lg-4 col-md-6">
                                                <label>DIRECCION DE RESIDENCIA</label>
                                                <input type="text" class="form-control" placeholder="Ingrese una direccion" name="direccion_residencia">
                                            </div>
                                            <div class="form-group col-lg-4 col-md-6">
                                                <label>ELIGE LA FORMA DE ENTREGA</label>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="forma_entrega_pedido_cliente" value="Enviar a domicilio" id="flexRadioDefault2" checked>
                                                    <label class="form-check-label" for="flexRadioDefault2">
                                                        Enviar a domicilio
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="forma_entrega_pedido_cliente" value="Retirar en el gimnasio" id="flexRadioDefault1">
                                                    <label class="form-check-label" for="flexRadioDefault1">
                                                        Retirar en el gimnasio
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="form-group col-lg-4 col-md-6">
                                                <label>FECHA ENTREGA PEDIDO</label>
                                                <input type="date" class="form-control" name="fecha_entrega_pedido_cliente">
                                            </div>
                                            <div class="form-group col-lg-4 col-md-6">
                                                <label>HORA ENTREGA PEDIDO</label>
                                                <input type="time" class="form-control" name="hora_entrega_pedido_cliente">
                                            </div>
                                            <div class="form-group col-lg-4 col-md-6">
                                                <label>¿Como Quires Pagar?</label>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="metodo_pago_pedido_cliente" id="flexRadioDefault2" checked>
                                                    <label class="form-check-label" for="flexRadioDefault2">
                                                        <i class="icofont-visa-electron"></i>  Visa Debito **** 1784
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="metodo_pago_pedido_cliente" value="Tarjeta de Credito" id="flexRadioDefault1">
                                                    <label class="form-check-label" for="flexRadioDefault1">
                                                        <i class="icofont-credit-card"></i> Tarjeta de Credito
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="metodo_pago_pedido_cliente" value="Tarjeta de Debito" id="flexRadioDefault1">
                                                    <label class="form-check-label" for="flexRadioDefault1">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="metodo_pago_pedido_cliente" value="Transferencia desde un banco con PSE" id="flexRadioDefault1">
                                                    <label class="form-check-label" for="flexRadioDefault1">
                                                        <i class="icofont-bank-alt"></i> Transferencia desde tu banco con PSE
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="metodo_pago_pedido_cliente" value="Pago  en efectivo con Efecty" id="flexRadioDefault1">
                                                    <label class="form-check-label" for="flexRadioDefault1">
                                            ...
                                            <div class="form-group col-lg-4 col-md-6">
                                                ...
                                                <input type="number" class="form-control" placeholder="Ingrese un precio" name="precio_final_venta_producto">
                                            </div>
                                            <div class="form-group col-lg-4 col-md-6">
