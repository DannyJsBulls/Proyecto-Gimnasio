<?php
    ...
    require_once("../../Controller/mostrarAdmin/mostrarProductosAdmin.php");
                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Productos de Gimnasio Registrados En El Sistema </h1>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
                        ...
                        <div class="col-lg-12">
                            <div class=card>
                                <div class="card-title">
                                    <h1>Tabla Informacion Productos de Gimnasio</h1>
