<?php
    ...
    require_once("../../Controller/mostrarPerfilAdministrador.php");
    ...
    // Obtenemos el valor del parámetro "id_user" de la URL
    if (isset($_GET['id_user'])) {
        $id_usuario_modificar = $_GET['id_user'];
        // Cargamos las actividades del usuario con el ID recibido
        // cargarActividadesusuario($id_usuario_modificar);
    } else {
        echo '<h2>No se pudo obtener el ID del usuario a modificar.</h2>';
    }
?>
<!DOCTYPE html>
<html lang="es">
                        ...
                        <div class="col-lg-12">
                            <div class=card>
                                <div class="card-title">
                                    <h1>Formulario de Actualizacion Perfiles de Usuario</h1>
                                    <h4>Por favor seleccione la accion que desa realizar</h4>
                                </div>

                                <div class="card-body">
                                    <?php
                                        cargarPerfilAdministrador($id_usuario);
                                    ?>
                                </div>
                            </div>
                        </div>
