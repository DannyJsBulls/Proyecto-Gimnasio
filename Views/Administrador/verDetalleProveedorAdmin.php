<?php
    ...
    require_once("../../Controller/mostrarAdmin/mostrarProveedorAdmin.php");
                        ...
                        <div class="col-lg-12">
                            <div class="card-extend">
                                <div class="card-title">
                                    <h1 class="titulo-perfil">Informacion De Proveedor</h1>
                                    <p class="parrafo-perfil">Por Favor seleccione la accion que desea realizar</p>
                                </div>
                                <?php
                                    cargarProveedorAdmin($id_usuario);
                                ?>
                            </div>
                        </div>
                    </div>
