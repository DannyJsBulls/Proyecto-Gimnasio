<?php
    ...
    require_once("../../Controller/mostrarAdmin/mostrarActividadesAdministrador.php");
                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Actividades Disponibles En el sistema </h1>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-title">
                                    <h1 class="titulo-perfil">ACTIVIDAD DISPONIBLES</h1>
                                    <p class="parrafo-perfil">Por Favor seleccione la accion que desea realizar</p>
                                </div>
                                <div class="row actividades"> 
                                    <?php
                                        mostrarActividadesAdministrador($id_usuario);
                                    ?>
                                </div>
                            </div>
                        </div>
