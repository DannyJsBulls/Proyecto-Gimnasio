<?php
    ...
    require_once("../../Controller/mostrarProveedor/mostrarEntrenadorProveedor.php");
                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Entrenadores Profesionales Disponibles </h1>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-title">
                                    <h1 class="titulo-perfil">Entrenadores Profesionales</h1>
                                    <p class="parrafo-perfil">Por Favor seleccione la accion que desea realizar</p>
                                </div>
                                <?php
                                    mostrarEntrenadorProveedor($id_usuario);
                                ?>
                            </div>
                        </div>
                    </div>
