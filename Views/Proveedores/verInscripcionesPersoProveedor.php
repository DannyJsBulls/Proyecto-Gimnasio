<?php
    ...
    require_once("../../Controller/mostrarProveedor/mostrarInscripcionesPersoProveedor.php");
                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Inscripciones Personalizadas de Actividades Registradas</h1>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
                        ...
                        <div class="col-lg-12">
                            <div class=card>
                                <div class="card-title">
                                    <h1>Tabla Informacion Inscripciones Personalizadas de Actividades</h1>
                                    <p>Por Favor seleccione la accion que desea realizar</p>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table id="bootstrap-data-table-export" class="table table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    <th>NUM.REFERENCIA ACTIVIDAD</th>
                                                    <th>NUM.REFERENCIA PLAN</th>
                                                    <th>IDENTIFICACION CLIENTE</th>
                                                    <th>IDENTIFICACION ENTRENADOR</th>
                                                    <th>FECHA DE INSCRIPCION</th>
                                                    <th>FECHA PROGRAMADA PARA LA ACTIVIDAD</th>
                                                    <th>HORA PROGRAMADA PARA LA ACTIVIDAD</th>
                                                    <th>ESTADO INSCRIPCION</th>
                                                    <th>COMENTARIOS</th>
                                                    <!-- <th>VER DETALLE INSCRIPCION</th> -->
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php
                                                    if(isset($id_usuario)){
                                                        mostrarInscripcionesPersoProveedor($id_usuario);
                                                    }
                                                ?>
                                            </tbody>
                                        </table>
