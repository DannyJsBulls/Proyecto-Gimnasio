<?php
    ...
    require_once("../../Controller/mostrarProveedor/mostrarEstadisticasPersonalizadasProveedor.php");
                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Estadisticas De Actividades Personalizadas Registradas</h1>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
                        ...
                        <div class="col-lg-12">
                            <div class=card>
                                <div class="card-title">
                                    <h1>Tabla Informacion Estadisticas Actividades Personalizadas</h1>
                                        ...
                                        <table id="bootstrap-data-table-export" class="table table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>ZONA FRECUENCIA</th>
                                                    <th>MAXIMO ESFUERZO</th>
                                                    <th>DIFICULTAD ACTIVIDAD</th>
                                            ...
                                            <tbody>
                                                <?php
                                                    if(isset($id_usuario)){
                                                        mostrarEstadisticasPersonalizadasProveedor($id_usuario);
                                                    }
                                                ?>
                                            </tbody>
                                        </table>
