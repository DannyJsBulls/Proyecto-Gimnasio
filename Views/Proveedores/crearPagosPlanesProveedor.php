                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-title">
                                    ...
                                    <h4>Por favor complete los campos para registrar un nuevo pago de planes</h4>
                                </div>
                                <div class="card-body">
                                    <!-- Parara qye un formulario pueda capturar archivos debe tener un atributo mas en la la eiqueta form que es ectyoe -->
                                    <form action="../../Controller/registrarProveedor/registrarPagosPlanesProveedor.php" method="POST">
                                        <div class="row">
                                            <div class="form-group col-lg-4 col-md-6">
                                                ...
                                                <select class="form-control" name="nombre_plan">
                                                    ...
                                                    <?php
                                                        ...
                                                        $query = "SELECT nombre_plan, codigo_plan FROM planes";
                                                        $result = $conexion->query($query);
                                                        while ($row = $result->fetch_assoc()) {
                                                            echo "<option value='" . $row['nombre_plan'] . "'>" . $row['nombre_plan'] . "</option>";
                                                        }
                                                        $conexion->close();
                                                    ?>
                                                </select>
                                            ...
                                            <div class="form-group col-lg-4 col-md-6">
                                                ...
                                                <input type="number" class="form-control" placeholder="Ingrese un numero id" name="id_usuario">
                                            </div>
                                            <div class="form-group col-lg-4 col-md-6">
                                                <label>FECHA VENTA</label>
                                                <input type="date" class="form-control" name="fecha_venta_plan">
                                            </div>
                                            <div class="form-group col-lg-4 col-md-6">
                                                <label>HORA VENTA</label>
                                                <input type="time" class="form-control" name="hora_venta_plan">
                                            </div>
                                            <div class="form-group col-lg-4 col-md-6">
                                                <label>FECHA FIN DEL PLAN</label>
                                                <input type="date" class="form-control" name="fecha_fin_plan">
                                            </div>
                                            <div class="form-group col-lg-4 col-md-6">
                                                <label>¿Como Quires Pagar?</label>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="metodo_pago_plan" id="flexRadioDefault2" checked>
                                                    <label class="form-check-label" for="flexRadioDefault2">
                                                        <i class="icofont-visa-electron"></i>  Visa Debito **** 1784
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="metodo_pago_plan" value="Tarjeta de Crédito" id="flexRadioDefault1">
                                                    <label class="form-check-label" for="flexRadioDefault1">
                                                        <i class="icofont-credit-card"></i> Tarjeta de Credito
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="metodo_pago_plan" value="Tarjeta de Débito" id="flexRadioDefault1">
                                                    <label class="form-check-label" for="flexRadioDefault1">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="metodo_pago_plan" value="Transferencia desde un banco con PSE" id="flexRadioDefault1">
                                                    <label class="form-check-label" for="flexRadioDefault1">
                                                        <i class="icofont-bank-alt"></i> Transferencia desde tu banco con PSE
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="metodo_pago_plan" value="Pago  en efectivo con Efecty" id="flexRadioDefault1">
                                                    <label class="form-check-label" for="flexRadioDefault1">
                                            ...
                                            <div class="form-group col-lg-4 col-md-6">
                                                ...
                                                <input type="number" class="form-control" placeholder="Ingrese un precio" name="precio_final_venta_plan">
                                            </div>
                                            <button type="submit" class="btn btn-primary">Comprar Plan</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
