<?php
    ...
    require_once("../../Controller/mostrarProveedor/mostrarEstadisticasLibresProveedor.php");
                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Estadisticas De Actividades Libres Registradas</h1>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
                        ...
                        <div class="col-lg-12">
                            <div class=card>
                                <div class="card-title">
                                    <h1>Tabla Informacion Estadisticas Actividades Libres</h1>
                                    ...
                                    <div class="table-responsive">
                                        <table id="bootstrap-data-table-export" class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <?php
                                                    if(isset($id_usuario)){
                                                        mostrarEstadisticasLibresProveedor($id_usuario);
                                                    }
                                                ?>
                                            </tbody>
                                        </table>
