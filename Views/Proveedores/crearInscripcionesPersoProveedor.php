                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Inscripciones Actividades Personalizadas</h1>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
                        ...
                        <div class="col-lg-12">
                            <div class=card>
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="../../Controller/registrarProveedor/registrarInscripcionesPersoProveedor.php" method="POST">
                                        <div class="row">
                                            ...
                                            <button type="submit" class="btn btn-primary">Inscribir Actividad</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
