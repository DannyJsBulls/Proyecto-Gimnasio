                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="card-planes">
                            <div class="card plan-bg">
                                ...
                                <p class="card-text-planes"> Nombre Plan: ' . $f['nombre_plan'] . '</p>
                                ...
                                <div class="row">
                                    <a href="verDetallePlanesAdmin.php?id_user=' . $f['codigo_plan'] . '" class="btn btn-primary boton">Ver Plan</a>
                                    <a href="../../Views/Administrador/crearPagos.php" class="btn btn-danger plan">Vender Plan</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="card-body">
                                ...
                                <a href="../../Views/Administrador/crearPagos.php" class="btn btn-primary training"> VENDER PLAN</a>
                            </div>
                        </div>
                    </div>
                </div>
