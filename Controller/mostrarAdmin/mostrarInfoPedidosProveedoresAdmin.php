<?php
    function mostrarInfoPedidosProveedorAdmin(){
        // Traemos la informacion de los usuarios desde el modelo, a partir de la clase y la funcion
        $objConsultas = new Consultas();
        $result = $objConsultas->mostrarInfoPedidosProveedoresAdmin();
            ...
            foreach ($result as $f) {
                echo '
                    <tr>
                        ...
                        <td>' . $f['precio_final_compra_producto_pedido'] . '</td>
                        ...
                        <td><a href="verDetallePedido.php?id_user=' . $f['id_proveedor'] . '" class="btn btn-warning"> Ver/Pedido</a></td>
                    </tr>
                ';
            }
        }
    ...
    function cargarPedidos(){
        ...
        $objConsultas = new Consultas();
        $result = $objConsultas->buscarPedidosAdmin($id_user);
    ...
    function cargarPedidosDetalle(){
        if (isset($_GET['id_user'])) {
            $id_user = $_GET['id_user'];
        
            $objConsultas = new Consultas();
            $result = $objConsultas->buscarPedidosDetalleAdmin($id_user);
