<?php
    function mostrarInfoClientesAdmin(){
            ...
            foreach ($result as $f) {
                echo '
                    <tr>
                        ...
                        <td>' . $f['rol_usuario'] . '</td>
                        <td>' . $f['clavemd'] . '</td>
                        <td><a href="modificarCliente.php?id_user=' . $f['id_usuario'] . '" class="btn btn-success"> Ver/Editar</a></td>
                        <td><a href="../../Controller/eliminarAdmin/eliminarClienteAdmin.php?id_user=' . $f['id_usuario'] . '" class="btn btn-danger"> Eliminar <i class="icofont-ui-delete"></i></a></td>
                    </tr>
                ';
            }
        }
     ...
     function cargarCliente(){
        ...
        foreach ($result as $f) {
            echo '
                <form action="../../Controller/modificarAdmin/modificarClienteAdmin.php" method="POST" enctype="multipart/form-data">
                    <div class="row">
