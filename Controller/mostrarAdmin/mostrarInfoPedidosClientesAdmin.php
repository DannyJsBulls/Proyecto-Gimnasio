            ...
            foreach ($result as $f) {
                echo '
                    <tr>
                        ...
                        <td><a href="verDetallePedidoCliente.php?id_user=' . $f['id_usuario'] . '" class="btn btn-warning"> Ver/Pedido</a></td>
                    </tr>
                ';
            }
        }
