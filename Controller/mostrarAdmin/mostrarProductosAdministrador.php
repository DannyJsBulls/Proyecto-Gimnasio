                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="card-actividades">
                            <div class="card-actividad-bg">
                                ...
                                <article>
                                <div class="row">
                                    <a href="verDetalleProductosAdmin.php?id_user=' . $f['codigo_producto'] . '" class="btn btn-primary boton">Ver Informacion</a>
                                    <a href="../Administrador/crearVentasClientes.php" class="btn btn-danger plan">Vender Producto</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="card-body">
                                ...
                                <p class="card-text mt-3 font-weight-bold">Estimado administrador,</p>
                                <p class="cta-description">Por favor, tenga en cuenta la posibilidad de vender productos del sistema a los clientes.<p>
                                <div class="row columna">
                                    <a href="../Administrador/crearVentasClientes.php" class="btn btn-primary training plan w-100"> VENDER PRODUCTO</a>
                                </div>
                            </div>
                        </div>
                    </div>
