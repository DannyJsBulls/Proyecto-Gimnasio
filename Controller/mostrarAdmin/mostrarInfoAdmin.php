<?php
            ...
            foreach ($result as $f) {
                echo '
                    <tr>
                        ...
                        <td>' . $f['rol_usuario'] . '</td>
                        <td>' . $f['clavemd'] . '</td>
                        <td><a href="modificarUsuario.php?id_user=' . $f['id_usuario'] . '" class="btn btn-success"> Ver/Editar</a></td>
                        <td><a href="../../Controller/eliminarAdmin/eliminarUserAdmin.php?id_user=' . $f['id_usuario'] . '" class="btn btn-danger"> Eliminar <i class="icofont-ui-delete"></i></a></td>
                    </tr>
                ';
            }
        }
    ...
    function cargarUser(){
        ...
        $objConsultas = new Consultas();
        $result = $objConsultas->buscarUser($id_user);

        foreach ($result as $f) {
            echo '
                <form action="../../Controller/modificarAdmin/modificarUserAdmin.php" method="POST" enctype="multipart/form-data">
                    <div class="row">
