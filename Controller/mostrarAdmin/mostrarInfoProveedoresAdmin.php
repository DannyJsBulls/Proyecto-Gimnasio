<?php
            ...
            foreach ($result as $f) {
                echo '
                    <tr>
                        ...
                        <td><a href="../../Controller/eliminarAdmin/eliminarProveedorAdmin.php?id_user=' . $f['id_usuario'] . '" class="btn btn-danger"> Eliminar <i class="icofont-ui-delete"></i></a></td>
                    </tr>
                ';
            }
        }
    ...
    function cargarProveedor(){
        ...
        $objConsultas = new Consultas();
        $result = $objConsultas->buscarProveedor($id_user);

        foreach ($result as $f) {
            echo '
                <form action="../../Controller/modificarAdmin/modificarProveedorAdmin.php" method="POST" enctype="multipart/form-data">
                    <div class="row">
