<?php
    function mostrarEntrenadorCliente($id_usuario){

        // Traemos la informacion de los usuarios desde el modelo, a partir de la clase y la funcion
        $objConsultas = new Consultas();
        $result = $objConsultas->mostrarEntrenadorCliente($id_usuario);
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="training"">
                            <div class="body">
                                ...
                                <article>
                                <div class="row">
                                    <a href="verDetalleEntrenador.php?id_user=' . $f['id_usuario'] . '" class="btn btn-primary boton">Ver Perfil</a>
                                    <a href="../Clientes/crearInscripcionesPersoCliente.php" class="btn btn-danger plan">Asignar Actividad</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    function cargarEntrenadorCliente($id_usuario){
        $id_user = $_GET['id_user'];

        $objConsultas = new Consultas();
        $result = $objConsultas->buscarEntrenadorCliente($id_user);
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                <div class="card-body">
                                    ...
                                    <a href="../Clientes/crearInscripcionesPersoCliente.php" class="btn btn-primary training"> ASIGNAR ACTIVIDADES</a>
                                </div>
                            </div>
                        </div>
                    </div>
