<?php
    function mostrarEstadisticasPersonalizadasCliente($id_cliente){

        // Traemos la informacion de los usuarios desde el modelo, a partir de la clase y la funcion
        $objConsultas = new Consultas();
        $result = $objConsultas->mostrarEstadisticasPersonalizadasCliente($id_cliente);
    ...
    function cargarEstadisticasPersonalizadasCliente($id_cliente){
        $id_user = $_GET['id_user'];

        $objConsultas = new Consultas();
        $result = $objConsultas->buscarEstadisticasPersonalizadasCliente($id_cliente);
