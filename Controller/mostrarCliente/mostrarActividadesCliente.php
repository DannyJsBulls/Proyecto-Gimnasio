<?php
    function mostrarActividadesCliente($id_usuario){

        // Traemos la informacion de los usuarios desde el modelo, a partir de la clase y la funcion
        $objConsultas = new Consultas();
        $result = $objConsultas->mostrarActividadesCliente($id_usuario);
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="card-actividades">
                            <div class="card-actividad-bg">
                                ...
                                <article>
                                <div class="row">
                                    <a href="verDetalleActividades.php?id_user=' . $f['codigo_actividad'] . '" class="btn btn-primary boton central">Ver Informacion</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    function cargarActividadesCliente(){
        $id_user = $_GET['id_user'];

        $objConsultas = new Consultas();
        $result = $objConsultas->buscarActividadesCliente($id_user);
