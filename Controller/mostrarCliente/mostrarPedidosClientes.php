<?php
    ...
    function cargarPedidosProductosClientes(){
        $id_user = $_GET['id_user'];

        $objConsultas = new Consultas();
        $result = $objConsultas->buscarPedidosProductosClientes($id_user);
    ...
    function cargarPedidosProductosCli(){
        if (isset($_GET['id_user'])) {
            $id_user = $_GET['id_user'];
        
            $objConsultas = new Consultas();
            $result = $objConsultas->buscarPedidosProductosCli($id_user);
