<?php
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="card-planes">
                            <div class="card plan-bg">
                                ...
                                <div class="row">
                                    <a href="verDetallePlanes.php?id_user=' . $f['codigo_plan'] . '" class="btn btn-primary boton">Ver Plan</a>
                                    <a href="../Clientes/crearPagosPlanesCliente.php" class="btn btn-danger plan">Comprar Plan</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    function cargarPlanesCliente(){
        $id_user = $_GET['id_user'];

        $objConsultas = new Consultas();
        $result = $objConsultas->buscarPlanesCliente($id_user);
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="card-body">
                                ...
                                <a href="../Clientes/crearPagosPlanesCliente.php" class="btn btn-primary training"> COMPRAR PLAN</a>
                            </div>
                        </div>
                    </div>
                </div>
