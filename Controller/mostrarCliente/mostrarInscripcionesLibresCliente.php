<?php
    function mostrarInscripcionesLibresCliente($id_usuario){

        // Traemos la informacion de los usuarios desde el modelo, a partir de la clase y la funcion
        $objConsultas = new Consultas();
        $result = $objConsultas->mostrarInscripcionesLibresCliente($id_usuario);
            ...
            foreach ($result as $f) {
                echo '
                    <tr>
                        ...
                        <!--<td><a href="modificarInscripcionesLibresCliente.php?id_user=' . $f['codigo_actividad'] . '" class="btn btn-success"> Ver Detalle</a></td>-->
                    </tr>
                ';
            }
        }
    ...
    function cargarInscripcionesLibresCliente($id_usuario){
        $id_user = $_GET['id_user'];

        $objConsultas = new Consultas();
        $result = $objConsultas->buscarInscripcionesLibresCliente($id_usuario);

        foreach ($result as $f) {
            echo '
                <form action="../../Controller/modificarInscripcionesLibresCliente.php" method="POST">
                    <div class="row">
