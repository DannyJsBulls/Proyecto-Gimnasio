<?php
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="card-actividades">
                            <div class="card-actividad-bg">
                                ...
                                <article>
                                <div class="row">
                                    <a href="verDetalleProductos.php?id_user=' . $f['codigo_producto'] . '" class="btn btn-primary boton">Ver Informacion</a>
                                    <a href="../Clientes/crearComprasClientes.php" class="btn btn-danger plan">Comprar Producto</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    function cargarProductosCliente(){
        ...
        $objConsultas = new Consultas();
        $result = $objConsultas->buscarProductosCliente($id_user);
                        ...
                        <div class="col-lg-6">
                            <div class="card-body">
                                ...
                                <div class="row columna">
                                    <a href="../Clientes/crearComprasClientes.php" class="btn btn-primary training plan w-100"> COMPRAR PRODUCTO</a>
                                </div>
                            </div>
                        </div>
                    </div>
