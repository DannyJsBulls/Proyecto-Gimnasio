<?php
    function mostrarPerfilEntrenador($id_usuario){

        // Traemos la informacion de los usuarios desde el modelo, a partir de la clase y la funcion
        $objConsultas = new Consultas();
        $result = $objConsultas->mostrarPerfilEntrenador($id_usuario);
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                <div class="card-body">
                                    ...
                                    <p class="card-text mt-3"> Fecha de Nacimiento: ' . $f['fecha_nacimiento_usuario'] . '</p>
                                    ...
                                    <a href="modificarPerfilEntrenador.php?id_user=' . $f['id_usuario'] . '" class="btn btn-primary training"> ACTUALIZAR DATOS</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    function cargarPerfilEntrenador($id_usuario){
        $id_user = $_GET['id_user'];

        $objConsultas = new Consultas();
        $result = $objConsultas->buscarPerfilEntrenador($id_user);

        foreach ($result as $f) {
            echo '
                <form action="../../Controller/modificarEntrenador/modificarUserEntrenador.php" method="POST" enctype="multipart/form-data">
                    <div class="row">
