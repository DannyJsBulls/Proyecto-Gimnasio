<?php
    function mostrarEstadisticasLibresProveedor($id_usuario){

        // Traemos la informacion de los usuarios desde el modelo, a partir de la clase y la funcion
        $objConsultas = new Consultas();
        $result = $objConsultas->mostrarEstadisticasLibresProveedor($id_usuario);
    ...
    function cargarEstadisticasLibresProveedor($id_usuario){
        $id_user = $_GET['id_user'];

        $objConsultas = new Consultas();
        $result = $objConsultas->buscarEstadisticasLibresProveedor($id_usuario);
