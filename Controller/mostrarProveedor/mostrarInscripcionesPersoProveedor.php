<?php
    function mostrarInscripcionesPersoProveedor($id_cliente){

        // Traemos la informacion de los usuarios desde el modelo, a partir de la clase y la funcion
        $objConsultas = new Consultas();
        $result = $objConsultas->mostrarInscripcionesPersoProveedor($id_cliente);
            ...
            foreach ($result as $f) {
                echo '
                    <tr>
                        ...
                        <!--<td><a href="modificarInscripcionesPersoProvee.php?id_user=' . $f['codigo_actividad'] . '" class="btn btn-success"> Ver Detalle</a></td>-->
                    </tr>
                ';
            }
        }
    ...
    function cargarInscripcionesPersoProveedor($id_cliente){
        $id_user = $_GET['id_user'];

        $objConsultas = new Consultas();
        $result = $objConsultas->buscarInscripcionesPersoProveedor($id_cliente);
