<?php
    ...
    function cargarPedidosProductosProveedores(){
        $id_user = $_GET['id_user'];

        $objConsultas = new Consultas();
        $result = $objConsultas->buscarPedidosProductosProveedores($id_user);
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="card-body">
                                ...
                                <h5 class="card-title mt-3">Numero de Identificacion: ' . $f['id_proveedor'] . '</h5>
    ...
    function cargarPedidosProductosProvee(){
        if (isset($_GET['id_user'])) {
            $id_user = $_GET['id_user'];
        
            $objConsultas = new Consultas();
            $result = $objConsultas->buscarPedidosProductosProvee($id_user);
