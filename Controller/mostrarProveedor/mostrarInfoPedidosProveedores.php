<?php
    function mostrarInfoPedidosProveedor($id_proveedor){
        // Traemos la informacion de los usuarios desde el modelo, a partir de la clase y la funcion
        $objConsultas = new Consultas();
        $result = $objConsultas->mostrarInfoPedidosProveedor($id_proveedor);
            ...
            foreach ($result as $f) {
                echo '
                    <tr>
                        ...
                        <td><a href="verDetallePedidoProveedorCom.php?id_user=' . $f['id_proveedor'] . '" class="btn btn-warning"> Ver/Pedido</a></td>
                    </tr>
                ';
            }
        }
    ...
    function cargarPedidosProveedores(){
        $id_user = $_GET['id_user'];

        $objConsultas = new Consultas();
        $result = $objConsultas->buscarPedidosProveedor($id_user);
    ...
    function cargarPedidosDetalleProvee(){
        if (isset($_GET['id_user'])) {
            $id_user = $_GET['id_user'];
        
            $objConsultas = new Consultas();
            $result = $objConsultas->buscarPedidosDetalleProvee($id_user);
