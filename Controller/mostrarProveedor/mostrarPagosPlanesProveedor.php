<?php
    function mostrarPagosPlanesProveedor($id_usuario){

        // Traemos la informacion de los usuarios desde el modelo, a partir de la clase y la funcion
        $objConsultas = new Consultas();
        $result = $objConsultas->mostrarPagosPlanesProveedor($id_usuario);
            ...
            foreach ($result as $f) {
                echo '
                    <tr>
                        ...
                        <td><a href="verDetallePagoProvee.php?id_user=' . $f['codigo_plan'] . '" class="btn btn-info"> Recibo de Pago</a></td>
                    </tr>
                ';
            }
        }
    ...
    function cargarPagosPlanesProveedor($id_usuario){
        $id_user = $_GET['id_user'];

        $objConsultas = new Consultas();
        $result = $objConsultas->buscarPagosPlanesProveedor($id_usuario);
