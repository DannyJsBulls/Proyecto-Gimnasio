<?php 
    ...
    if ($_FILES['foto_usuario']['error']) {
        ...
        if (in_array($_FILES['foto_usuario']['type'], $PERMITIDOS) && $_FILES['foto_usuario']['size'] <= LIMITE * 1024) {
            ...
            $result = $objConsultas->registrarUserAdmin($id_usuario, $tipo_documento_usuario, $nombres_usuario, $apellidos_usuario, $fecha_nacimiento_usuario, $email_usuario, $telefono_usuario, $estado_usuario, $rol_usuario, $clavemd, $foto_usuario);
