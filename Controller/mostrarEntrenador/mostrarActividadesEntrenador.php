<?php
    function mostrarActividadesEntrenador($id_usuario){

        // Traemos la informacion de los usuarios desde el modelo, a partir de la clase y la funcion
        $objConsultas = new Consultas();
        $result = $objConsultas->mostrarActividadesEntrenador($id_usuario);
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="card-actividades">
                            <div class="card-actividad-bg">
                                ...
                                <article>
                                <div class="row">
                                    <a href="verDetalleActividadesEntrenador.php?id_user=' . $f['codigo_actividad'] . '" class="btn btn-primary boton central">Ver Informacion</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    function cargarActividadesEntrenador(){
        $id_user = $_GET['id_user'];

        $objConsultas = new Consultas();
        $result = $objConsultas->buscarActividadesEntrenador($id_user);
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="card-body">
                                ...
                                <h2 class="cta-title">¡Descubre tus estadísticas personalizadas!</h2>
                                <p class="cta-description">Explora las estadísticas detalladas y personalizadas que has generado como entrenador.</p>
                                <div class="row columna">
                                    <div class="col-lg-6">
                                        <a href="../Entrenadores/verEstadisticasPersoEntrenador.php" class="btn btn-primary training plan"> VER ESTADISTICAS</a>
                                    </div>
                                </div>
                            </div>
                        </div>
