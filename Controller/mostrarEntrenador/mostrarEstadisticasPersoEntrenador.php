<?php
    function mostrarEstadisticasPersoEntrenador($id_entrenador){

        // Traemos la informacion de los usuarios desde el modelo, a partir de la clase y la funcion
        $objConsultas = new Consultas();
        $result = $objConsultas->mostrarEstadisticasPersoEntrenador($id_entrenador);
            ...
            foreach ($result as $f) {
                echo '
                    <tr>
                        ...
                        <!--<td><a href="modificarEstadisticasPersonalizadas.php?id_user=' . $f['id_cliente'] . '" class="btn btn-success"> Ver Detalle</a></td>-->
                    </tr>
                ';
            }
        }
    ...
    function cargarEstadisticasPersoEntrenador(){
        $id_user = $_GET['id_user'];

        $objConsultas = new Consultas();
        $result = $objConsultas->buscarEstadisticasPersoEntrenador($id_user);
