<?php
    ...
    function cargarPedidosProductosEntrenadores(){
        $id_user = $_GET['id_user'];

        $objConsultas = new Consultas();
        $result = $objConsultas->buscarPedidosProductosEntrenadores($id_user);
    ...
    function cargarPedidosProductosEntre(){
        if (isset($_GET['id_user'])) {
            $id_user = $_GET['id_user'];
        
            $objConsultas = new Consultas();
            $result = $objConsultas->buscarPedidosProductosEntre($id_user);
