<?php
    function mostrarInscripcionesPersoentrenador($id_entrenador){

        // Traemos la informacion de los usuarios desde el modelo, a partir de la clase y la funcion
        $objConsultas = new Consultas();
        $result = $objConsultas->mostrarInscripcionesPersoEntrenador($id_entrenador);
    ...
    function cargarInscripcionesPersoEntrenador($id_cliente){
        $id_user = $_GET['id_user'];

        $objConsultas = new Consultas();
        $result = $objConsultas->buscarInscripcionesPersoEntrenador($id_cliente);
