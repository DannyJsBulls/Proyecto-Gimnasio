<?php
    function mostrarComprasEntrenadores($id_usuario){

        // Traemos la informacion de los usuarios desde el modelo, a partir de la clase y la funcion
        $objConsultas = new Consultas();
        $result = $objConsultas->mostrarComprasEntrenadores($id_usuario);
            ...
            foreach ($result as $f) {
                echo '
                    <tr>
                        ...
                        <td><a href="verDetallePedidosComEntrenadores.php?id_user=' . $f['id_usuario'] . '" class="btn btn-warning"> Ver Pedido</a></td>
                        <td><a href="verDetalleCompraEntrenadores.php?id_user=' . $f['id_usuario'] . '" class="btn btn-info"> Recibo De Pago</a></td>
                    </tr>
                ';
            }
        }
    ...
    function cargarComprasEntrenadores($id_usuario){
        $id_user = $_GET['id_user'];

        $objConsultas = new Consultas();
        $result = $objConsultas->buscarComprasEntrenadores($id_usuario);
