<?php
    function mostrarInfoPedidosEntrenador($id_usuario){
        // Traemos la informacion de los usuarios desde el modelo, a partir de la clase y la funcion
        $objConsultas = new Consultas();
        $result = $objConsultas->mostrarInfoPedidosEntrenadores($id_usuario);
            ...
            foreach ($result as $f) {
                echo '
                    <tr>
                        ...
                        <td><a href="verDetallePedidoEntrenadorCom.php?id_user=' . $f['id_usuario'] . '" class="btn btn-warning"> Ver/Pedido</a></td>
                    </tr>
                ';
            }
        }
    ...
    function cargarPedidosEntrenadores(){
        $id_user = $_GET['id_user'];

        $objConsultas = new Consultas();
        $result = $objConsultas->buscarPedidosEntrenador($id_user);
    ...
    function cargarPedidosDetalleEntre(){
        if (isset($_GET['id_user'])) {
            $id_user = $_GET['id_user'];
        
            $objConsultas = new Consultas();
            $result = $objConsultas->buscarPedidosDetalleEntre($id_user);
