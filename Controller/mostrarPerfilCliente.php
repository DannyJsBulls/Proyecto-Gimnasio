<?php
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                <div class="card-body">
                                    ...
                                    <a href="modificarPerfilCliente.php?id_user=' . $f['id_usuario'] . '" class="btn btn-primary admin"> ACTUALIZAR DATOS</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    function cargarPerfilCliente($id_usuario){
        $id_user = $_GET['id_user'];

        $objConsultas = new Consultas();
        $result = $objConsultas->buscarPerfilCliente($id_user);

        foreach ($result as $f) {
            echo '
                <form action="../../Controller/modificarCliente/modificarUserCliente.php" method="POST" enctype="multipart/form-data">
                    <div class="row">
